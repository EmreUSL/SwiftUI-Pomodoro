...
//  T1-Pomodoro
//
//  Created by emre usul on 1.03.2023.
//
...
var sample_analytics: [SiteView] = [
    ...
    SiteView(hour: Date().updateHour(value: 15), views: 5320),
    SiteView(hour: Date().updateHour(value: 16), views: 8500),
    SiteView(hour: Date().updateHour(value: 17), views: 4503),
    SiteView(hour: Date().updateHour(value: 18), views: 2245),
    SiteView(hour: Date().updateHour(value: 19), views: 6875),
]
